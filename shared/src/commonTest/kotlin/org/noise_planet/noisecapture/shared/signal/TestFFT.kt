...
class TestFFT {
    ...
    fun testFFT() {
        ...
        val expected = doubleArrayOf(28.0, 0.0, -4.0, 9.65685424949238, -4.0, 4.0, -4.0,
    ...
    fun testFFTFloat() {
        ...
        // np.hstack((result.real[:, None], result.imag[:, None])).flatten()
        val expected = floatArrayOf(28.0F, 0.0F, -4.0F, 9.656855F, -4.0F, 4.0F, -4.0F,
    ...
    @Test
    fun testRFFT2() {
        val values = doubleArrayOf(0.00000000e+00,  8.31469612e-01,  9.23879533e-01,  1.95090322e-01,
        ...
        val expected = doubleArrayOf(6.357727552008862e-15, 0.0, -2.887112575184895e-15, 7.586883716628833e-15, -4.681264813764543e-15, -2.3033681535895184e-15, 1.168027486177751e-15, -5.27151586969653e-15, 2.7067429112899688e-15, 9.688948784381873e-16, -5.608327010386881e-15, -16.0, 2.3949282893188493e-15, -1.876232130942726e-15, 3.3851329943375557e-15, 2.990967016227153e-15, -2.2187453132204726e-15, 1.8596235662471372e-15, -1.0570661146844079e-15, -2.5601481068986296e-15, 3.3044820170772633e-15, -3.2528972154800725e-17, -3.8319701709866305e-15, 5.329070518200751e-15, -2.5923191367677723e-15, -2.0287072880497354e-15, -1.2824512606999475e-15, -7.0478727090967805e-15, 1.4311481056631361e-15, -1.791932624351781e-15, 5.215179454838043e-15, -5.069658764097952e-15, 2.749502721977103e-15, 0.0)
        val rfftVal = realFFT(values)
        expected.forEachIndexed { index, value ->
            assertEquals(value, rfftVal[index], 1e-8)
        }
