package org.noiseplanet.noisecapture.shared.ui

import androidx.compose.ui.graphics.Color
import androidx.compose.ui.graphics.toArgb
import androidx.compose.ui.unit.IntSize
import org.noiseplanet.noisecapture.shared.FFT_SIZE
...
class SpectrogramBitmap {
    ...
    companion object {
        ...
        val bmpHeader = intArrayOf( // All values are little-endian
            ...
            0x00,
            0x00,
            0x00, // DIB header size (124 bytes)
            0x04,
            0x00,
            0x00,
            0x00, // Width (4px)
            ...
            0x00,
            0x00,
            0x00, // Format (bitfield = use bitfields | no compression)
            0x20,
            0x00,
            0x00,
            0x00, // Image raw size (32 bytes)
            0x13,
            0x0B,
            0x00,
            0x00, // Horizontal print resolution (2835 = 72dpi * 39.3701)
            0x13,
            0x0B,
            0x00,
            0x00, // Vertical print resolution (2835 = 72dpi * 39.3701)
            0x00,
            0x00,
            0x00,
            0x00, // Colors in palette (none)
            0x00,
            0x00,
            0x00,
            ...
            0x00,
            0xFF,
            0x00, // R bitmask (00FF0000)
            0x00,
            0xFF,
            0x00,
            0x00, // G bitmask (0000FF00)
            0xFF,
            0x00,
            0x00,
            0x00, // B bitmask (000000FF)
            0x00,
            0x00,
            0x00,
            0xFF, // A bitmask (FF000000)
            0x42,
            0x47,
            0x52,
            0x73, // sRGB color space
            0x00,
            0x00,
            0x00,
            0x00,
            ...
            0x00,
            0x00,
            0x00, // Unused Gamma X entry for color space
            0x00,
            0x00,
            0x00,
            0x00, // Unused Gamma Y entry for color space
            0x00,
            0x00,
            0x00,
            0x00, // Unused Gamma Z entry for color space
            0x00,
            0x00,
            0x00,
            0x00, // Unknown
    ...
    data class SpectrogramDataModel(
        val size: IntSize, val byteArray: ByteArray,
        var offset: Int = 0, val scaleMode: ScaleMode,
