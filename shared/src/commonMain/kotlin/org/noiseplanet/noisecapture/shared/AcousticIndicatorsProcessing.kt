package org.noiseplanet.noisecapture.shared

import org.noiseplanet.noisecapture.AudioSamples
import org.noiseplanet.noisecapture.shared.signal.SpectrumChannel
import org.noiseplanet.noisecapture.shared.signal.get44100HZ
import org.noiseplanet.noisecapture.shared.signal.get48000HZ
...
data class AcousticIndicatorsData(
    val epoch: Long, val leq: Double, val laeq: Double,
