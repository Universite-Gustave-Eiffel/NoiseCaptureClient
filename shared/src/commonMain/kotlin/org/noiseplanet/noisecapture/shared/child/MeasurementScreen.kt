// TODO: Remove detekt suppression after Appyx refactor
...
import org.noiseplanet.noisecapture.shared.ANDROID_GAIN
import org.noiseplanet.noisecapture.shared.FFT_HOP
import org.noiseplanet.noisecapture.shared.MeasurementService
import org.noiseplanet.noisecapture.shared.ScreenData
import org.noiseplanet.noisecapture.shared.WINDOW_TIME
import org.noiseplanet.noisecapture.shared.signal.FAST_DECAY_RATE
import org.noiseplanet.noisecapture.shared.signal.LevelDisplayWeightedDecay
import org.noiseplanet.noisecapture.shared.signal.SpectrumData
import org.noiseplanet.noisecapture.shared.ui.SpectrogramBitmap
...
class MeasurementScreen(
    ...
    var preparedLegendBitmap =
        LegendBitmap(ImageBitmap(1, 1), Size(0F, 0F), Size(0F, 0F), Size(0F, 0F))
    ...
    private fun makeXLegend(
        textMeasurer: TextMeasurer, timeValue: Double, legendWidth: Float,
        timePerPixel: Double, depth: Int,
    ): LegendElement {
    ...
    @Composable
    fun spectrogramLegend(scaleMode: SpectrogramBitmap.Companion.ScaleMode, sampleRate: Double) {
