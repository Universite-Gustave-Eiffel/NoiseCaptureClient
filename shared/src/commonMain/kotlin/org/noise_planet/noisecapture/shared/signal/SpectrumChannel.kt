...
class SpectrumChannel {
    ...
    private var minimumSamplesLength = 0
    ...
    private fun toArray(array: List<Double>): DoubleArray {
        val retValue = DoubleArray(array.size)
     ...
     */
    fun loadConfiguration(configuration: SpectrumChannelConfiguration, useCascade: Boolean) {
        subSamplers.clear()
        bandFilterSize = 0
